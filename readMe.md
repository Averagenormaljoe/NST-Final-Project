...
- [StyleMotion - A Model with a Interactive User Interface for](#stylemotion---a-model-with-a-interactive-user-interface-for)
  ...
  - [General code](#general-code)
    ...
    - [Gatys_model (Gatys) - "Gatys_model" directory](#Gatys_model-gatys---Gatys_model-directory)
...
### Gatys_model (Gatys) - "Gatys_model" directory
...
5. Go to the notebook. For Gatys_model, it is the 'prototype.ipynb' file.
